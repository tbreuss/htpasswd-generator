            ...
            <div class="pure-g">
                ...
                <div class="pure-u-1 pure-u-md-1-2">
                    <div class="l-box">
                        ...
                        <p>Mehr zum Thema <i>HTTP-Authentifizierung</i> und wie man dies auf einem NCSA-kompatiblen
                            Webserver erreicht, erfährst du unter <router-link to="/infos">Infos</router-link>.</p>
                    </div>
                </div>
            </div>
        </div>
