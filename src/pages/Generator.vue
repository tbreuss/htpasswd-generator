            ...
            <div class="pure-u-1">
                ...
                <div class="pure-form pure-form-stacked">
                    ...
                    <fieldset>
                        ...
                        <div class="pure-g" v-for="(login, index) in logins">
                            <div class="pure-u-1 pure-u-md-1-3">
                                <label v-if="index < 1" v-bind:for="'username-' + index">Benutzername</label>
                            </div>
                            <div class="pure-u-1 pure-u-md-1-3">
                                <label v-if="index < 1" v-bind:for="'password-' + index">Passwort</label>
                            </div>
                            <div class="pure-u-1 pure-u-md-1-3">
                            </div>
                            <div class="pure-u-1 pure-u-md-1-3">
                                <input class="pure-u-1" v-bind:id="'username-' + index" type="text" v-model="login.username"
                                       placeholder="Hans">
                            </div>
                            <div class="pure-u-1 pure-u-md-1-3">
                                <input class="pure-u-1" v-bind:id="'password-' + index" type="text" v-model="login.password"
                                       placeholder="*****">
                            </div>
                            <div class="pure-u-1 pure-u-md-1-3 buttons">
                                <button class="pure-button button-small" @click="addLogin">hinzufügen</button>
                                <button class="pure-button button-small" v-if="index > 0" @click="removeLogin(index)">
                                    entfernen
                                </button>
                            </div>
                        </div>
